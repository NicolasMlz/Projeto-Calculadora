...
public class Teclado extends JPanel implements ActionListener {
	...
	public Teclado() {
		...
		//Configuracoes do teclado como um todo
		setLayout(layout);
		//Preencher o teclado na tela toda
		c.weightx = 1;
		c.weighty = 1;
		c.fill = GridBagConstraints.BOTH;
		
		//Adicionar botoes com as configuracoes desejadas
		//Linha 1
		c.gridwidth = 2;
	...
	//Metodos
	//Adicionar botao com as devidas dimensoes
	...
	//Captar o texto do botao clicado (PORTEIRO)
	@Override
	public void actionPerformed(ActionEvent e) {
		if(e.getSource() instanceof JButton) {
			JButton botao = (JButton) e.getSource();
			Memoria.getInstancia().processarDigito(botao.getText());
		}
	}
